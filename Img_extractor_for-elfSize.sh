...
# Extract images
extract_image "./download/img/rootfs.img" "./download/img/extracted/rootfs" "extract_errors_ROOTFS.log" "rootfs.img"
convert_symlink "./download/img/extracted/rootfs"
extract_image "./download/img/hal.img" "./download/img/extracted/hal" "extract_errors_hal.log" "hal.img"
convert_symlink "./download/img/extracted/hal"
extract_image "./download/img/modules.img" "./download/img/extracted/modules" "extract_errors_modules.log" "modules.img"
convert_symlink "./download/img/extracted/modules"
extract_image "./download/img/system-data.img" "./download/img/extracted/opt" "extract_errors_opt.log" "system-data.img"
convert_symlink "./download/img/extracted/opt"
